...
const resources = {
  ...
  ar: {
    translation: {
      nav: { work: "أعمال", services: "خدمات", about: "عني", faq: "أسئلة شائعة", contact: "اتصال" },
      hero: {
  ...
  fr: {
    translation: {
      nav: { work: "TRAVAUX", services: "SERVICES", about: "À PROPOS", faq: "FAQ", contact: "CONTACT" },
      hero: {
  ...
  zh: {
    translation: {
      nav: { work: "项目", services: "服务", about: "关于我", faq: "常见问题", contact: "联系" },
      hero: {
        role: "前端软件工程师",
        title1: "创意",
        title2: "工程师",
